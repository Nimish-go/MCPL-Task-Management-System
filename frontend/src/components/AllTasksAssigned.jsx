    ...
    >
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          ...
          <Typography
            sx={{ fontSize: "0.8rem", fontWeight: 600, color: "#1976d2" }}
          >
            #{task.id}
          </Typography>
        </Box>
      ...
      >
        <Box>
          ...
          <Box
            sx={{ display: "flex", alignItems: "center", gap: 0.7, mt: 0.3 }}
          >
            <Box
              sx={{
                width: 22,
            ...
            >
              <Typography
                sx={{ fontSize: "0.6rem", fontWeight: 700, color: "#1976d2" }}
              >
        ...
        <Box>
          ...
          <Typography sx={{ fontSize: "0.78rem", mt: 0.3, color: "#475569" }}>
            {task.assigned_by}
          </Typography>
        </Box>
      </Box>
      ...
      >
        <Box>
          ...
          <Typography sx={{ fontSize: "0.78rem", color: "#475569", mt: 0.3 }}>
    ...
    >
      ...
      {tasks.length > 0 && (
        <Typography level="body-xs" sx={{ color: "#94a3b8" }}>
          {startIndex + 1}–{Math.min(startIndex + rows, tasks.length)} of{" "}
          {tasks.length}
        </Typography>
      )}
    </Box>
    ...
    <Box sx={{ p: { xs: 1.5, sm: 3 } }}>
      ...
      >
        ...
        >
          ...
          <Typography
            level="title-sm"
            sx={{ fontWeight: 700, color: "#0f1b35", whiteSpace: "nowrap" }}
          >
            Filter by Employee
          </Typography>
        </Box>
