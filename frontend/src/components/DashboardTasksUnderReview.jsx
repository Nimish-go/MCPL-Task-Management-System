...
// ─── Active tasks table (shared by employee & project drill-down) ─────────────
...
// ─── Completed tasks table (shared by employee & project drill-down) ──────────
...
const DashboardTasksUnderReview = ({ refreshKey = 0, onRefresh }) => {
  ...
  // ── Drill-down active for current tab ────────────────────────────────────
  ...
  return (
    <Box sx={{ p: { xs: 2, sm: 3 } }}>
      ...
      >
        {/* Header: title + tab toggles (hidden during drill-down) */}
        <Box
          sx={{
            display: "flex",
                      ...
                      {loading ? (
                        ...
                        filteredProjectList.map((proj, i) => (
                          <tr
                            ...
                            onClick={() => loadProjectDetails(proj.projectCode)}
                            onMouseEnter={(e) =>
                              (e.currentTarget.style.backgroundColor =
                                "#f0f4ff")
                            }
